...
// transponse event listener to the global object
Wdjs.prototype.on = function() {
    EventHandler.on.apply(EventHandler, Array.prototype.slice.call(arguments));
}

// expose event emitter to the global object
Wdjs.prototype.emit = function() {
    EventHandler.emit.apply(EventHandler, Array.prototype.slice.call(arguments));
}